...
private:
    Repository& repo;             // referinta la repo (nu o detinem - alta clasa o gestioneaza)
...
public:
    ...
    UndoAdauga(Repository& repo, const std::string& nrInmatriculare)
...
public:
    ...
    UndoSterge(Repository& repo, const Masina& masinaSteasa)
...
public:
    ...
    UndoModifica(Repository& repo, const Masina& masinaVeche)
